...
function tribonacci(signature, n) {
  ...
  for (let i = 0; i < n; i++) {
    const newValue = newArray.slice(i).reduce((a, b) => a + b);
...
console.log(tribonacci([20, 30, 10], 0));
console.log(tribonacci([20, 30, 10], 1));
console.log(tribonacci([20, 30, 10], 2));
console.log(tribonacci([20, 30, 10], 3));
